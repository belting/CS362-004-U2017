...
int playAdventurerCard(struct gameState *state, int temphand[], int z){
...
int playFeastCard(int currentPlayer, struct gameState *state, int choice1, int temphand[]){
...
int playBaronCard(struct gameState *state, int currentPlayer, int choice1){
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case adventurer:
      ...
      return playAdventurerCard(state, temphand, z);
			
    case council_room:
      //+4 Cards
      return playCouncil_roomCard(handPos, currentPlayer, state);
			
    case feast:
      //gain card with cost up to 5
      //Backup hand
      return playFeastCard(currentPlayer, state, choice1, temphand);
    ...
    case smithy:
      ...
      return playSmithyCard(handPos, state, currentPlayer);
    ...
    case baron:
      ...
      return playBaronCard(state, currentPlayer, choice1);
